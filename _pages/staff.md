  ...
  <div class="max-w-6xl mx-auto">
      <div class="mb-24">
        <div class="text-center mb-16">
          ...
          <p class="text-xl mt-2" style="color: #444444;">一緒に運営しませんか</p>
        </div>
        <div class="text-center mb-16 max-w-4xl mx-auto">
          <p class="text-xl leading-relaxed mb-8" style="color: #221C35;">
            Coolest Projects Japan 2026の運営スタッフを募集しています！<br>
            子どもたちの創造性を育むイベントを一緒に作り上げましょう。
          </p>
          <p class="text-lg leading-relaxed" style="color: #444444;">
            年齢・経験は一切不問です。どなたでも大歓迎！<br>
            イベントを一緒に盛り上げてくれる方を募集しています。
          </p>
        </div>
      </div>
      <div class="mb-24">
        ...
        <div class="text-center mb-12">
          <p class="text-xl mb-8" style="color: #444444;">
            運営スタッフとして参加を希望される方は、<br>
            下のボタンから応募フォームに進んでください。
          </p>
          <a class="button-push" href="https://docs.google.com/forms/d/e/1FAIpQLSehzWUbWrMzPGjA412NgqyP4mOyAiidgG7EF2BNTUMfoe387g/viewform" target="_blank"> 運営応募フォーム(Google Form) </a>
        </div>
      </div>
    </div>
  </div>
