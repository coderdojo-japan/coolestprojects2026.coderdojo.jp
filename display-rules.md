  ...
  <div class="max-w-4xl mx-auto">
    ...
    <div class="mb-16">
      ...
      <div class="text-center mb-12">
        <h2 class='text-4xl sm:text-5xl font-bold uppercase tracking-wider border-b-10 border-teal-500 inline-block' style="font-family: 'League Gothic', sans-serif; color: #221C35;">DISPLAY RULES</h2>
        <p class="text-xl mt-2" style="color: #444444;">展示のおやくそく</p>
      </div>
