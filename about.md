...
<div class="bg-white py-16 px-4">
  <div class="max-w-4xl mx-auto">
      ...
      <div class="flex flex-col sm:flex-row gap-4 mb-4 sm:pr-4">
        <img src="/img/flyer-1.webp" alt="Coolest Projects Japan 2026 チラシ（表）" class="rounded-xl shadow w-full sm:w-1/2">
        <img src="/img/flyer-2.webp" alt="Coolest Projects Japan 2026 チラシ（裏）" class="rounded-xl shadow w-full sm:w-1/2">
      </div>
      <div class="mb-16">
		  ...
		  <a href="/schedule">
		    ...
		    【&raquo; 詳細を見る】
              ...
              <tr class="border-b border-gray-200">
                ...
                <td class="py-6 px-4 text-lg" style="color: #444444;">
                  <a href="#team" class="inline-flex items-center gap-1">Coolest Projects Japan 実行委員会</a><br>
		  <a href="https://coderdojo.jp/" target="_blank" class="inline-flex items-center gap-1">一般社団法人 CoderDojo Japan<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" /></svg></a>
                </td>
              </tr>
              <tr class="border-b border-gray-200">
                <td class="py-6 px-4 font-bold text-lg" style="color: #221C35;">
